    ...
    <div class="modal-content" @click.stop>
      ...
      <form @submit.prevent="addQuestion" class="question-form">
        ...
        <div class="form-group">
          ...
          <select id="quizSelect" v-model="newQuestion.quiz_id" required>
        ...
        <div class="form-group">
          ...
          <select id="correctOption" v-model="newQuestion.correct_option" required>
...
export default {
  ...
  methods: {
    ...
    async addQuestion() {
      ...
      try {
        await axios.post("http://localhost:5000/question", this.newQuestion, {
          headers: {
